 ...
 * このバージョンは、コンパチパッケージに対応しています。
 *
 * @author Ushi
 */
public class ProgressDialogFragmentCompat extends BaseDialogFragmentCompat {
	...
	public ProgressDialogFragmentCompat(DialogConfig config) {
	...
	public static class Builder {
		 ...
		 *
		 * @return {@link ProgressDialogFragmentCompat}
		 */
		public ProgressDialogFragmentCompat create() {
			return new ProgressDialogFragmentCompat(mConfig);
		}
